...
successfully identifies three conflicts in an example puzzle.
The test utilises an index of an example puzzle that contains conflicts when the cell is set to several different cells values.
