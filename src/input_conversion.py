...
@details This module contains the input_converter function which takes in an input.txt file with the structure
...
def input_converter(puzzle):
    ...
    The function includes error traps to ensure that the puzzle is solvable.
